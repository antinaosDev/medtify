...
# WhatsApp Client — switchable: Evolution API or OpenWA
import os as _os
if _os.environ.get("WHATSAPP_BACKEND", "evolution").lower() == "openwa":
    from openwa_adapter import OpenWAAdapter as EvolutionClient
    logger.info("[CONFIG] Using OpenWA backend")
else:
...
# ============================================================
EVO_API_URL_CODE = "https://molecular-applications-schema-demonstration.trycloudflare.com"
...
with st.sidebar:
    ...
    # ==========================================================
    # CONFIG TÉCNICA: Solo visible para PROGRAMADOR
    # ==========================================================
    if str(st.session_state.get("rol_usuario", "")).strip().upper() == "PROGRAMADOR":
        st.markdown("---")
        st.markdown("### ⚙️ WhatsApp Backend (Config)")
    ...
    # ==========================================================
    # ESTADO Y GESTIÓN: Visible para TODOS los usuarios
    # ==========================================================
    st.markdown("---")
